...
class MultiPathPlanGenerationState(BaseModel):
    ...
    chosen_options: Annotated[list[int], operator.add] = Field(default_factory=list,
...
class OptionPresenter:
    ...
    def run(self, task: Task) -> int:
        ...
        chain = (choice_prompt | self.llm.with_config(configurable=dict(max_tokens=1)) |
                 StrOutputParser())
...
class ResultAggregator:
    ...
    @staticmethod
    def _format_task_results(tasks: list[Task], chosen_options: list[int],
